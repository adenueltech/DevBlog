      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <Card className="shadow-2xl border-0 bg-card/80 backdrop-blur-sm">
          <CardHeader className="text-center pb-6">
            ...
            <CardTitle className="text-2xl font-bold">Join DevBlog</CardTitle>
            <CardDescription>
              Create your account and start sharing your developer journey with the community.
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-3">
              <Button variant="outline" className="w-full gap-2 hover:bg-muted bg-transparent" size="lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" className="w-full h-11" size="lg" disabled={isLoading || !agreedToTerms}>
